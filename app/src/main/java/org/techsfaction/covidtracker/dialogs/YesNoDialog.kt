 ...
 * A YesNoDialog asks the user if he/she wants to do something or notpackage org.y20k.covidtracker.dialogs
 *
...
class YesNoDialog (private var yesNoDialogListener: YesNoDialogListener) {
    ...
    fun show(context: Context,
        ...
        val builder: MaterialAlertDialogBuilder = MaterialAlertDialogBuilder(context, R.style.AppTheme)
