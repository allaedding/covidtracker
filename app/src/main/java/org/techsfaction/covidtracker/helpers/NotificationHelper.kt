...
import org.techsfaction.covidtracker.MainActivity
import org.techsfaction.covidtracker.R
import org.techsfaction.covidtracker.TrackerService
    ...
    fun createNotification(trackingState: Int, trackLength: Float, duration: Long, useImperial: Boolean): Notification {
        ...
        when (trackingState) {
            Keys.STATE_TRACKING_ACTIVE -> {
                builder.setContentTitle(trackerService.getString(R.string.notification_title_covidtracker_running))
                ...
                builder.setContentTitle(trackerService.getString(R.string.notification_title_covidtracker_not_running))
