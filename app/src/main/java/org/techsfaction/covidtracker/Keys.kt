...
object Keys {
    ...
    // application name
    const val APPLICATION_NAME: String = "covidtracker"
    ...
    // intent actions
    const val ACTION_START: String = "org.y20k.covidtrackers.action.START"
    const val ACTION_STOP: String = "org.y20k.covidtrackers.action.STOP"
    ...
    const val covidtracker_LEGACY_FILE_EXTENSION: String = ".covidtracker"
    const val covidtracker_FILE_EXTENSION: String = ".json"
